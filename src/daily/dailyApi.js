...
// default (same reason supabaseClient.js's fetchAllRows loops), and this
// table passed that a while ago. Without the loop, anyone whose rows fell
// past the first page was silently undercounted (or missing entirely,
// dropping them below the played>=3 cutoff) despite having really played
// enough — same bug fetchAllRows was written to avoid elsewhere.
